...
-(void) prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    ...
    ImageViewController *imv = [segue destinationViewController];
    NSIndexPath *path = [self.tableView indexPathForSelectedRow];
        
    Photo *c = [photos objectAtIndex:path.row];
    [imv setCurrentImage:c];
...
- (void)viewDidLoad
{
    ...
    [pic setDecription:@"beach descriptio nklfjsdkf"];
    ...
    [pic setDecription:@"bwinerywi nerywin erywinery decr"];
